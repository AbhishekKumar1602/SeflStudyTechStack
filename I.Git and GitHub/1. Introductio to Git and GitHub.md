...
```
B. **Using "git show":** The git show command allows us to view the changes introduced by a specific commit. We can use it to inspect the details of a particular commit.
```
...
```
Note: --hard discards all changes in your working directory and staging area, positioning your current branch pointer at the specified commit-hash.
```
git reset --soft <commit-hash>
```
Note: --soft preserves changes in your working directory and staging area, facilitating further modifications or commits based on the specified commit-hash.
